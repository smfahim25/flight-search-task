      ...
      <form>
        <div class="grid gap-6 mb-6 md:grid-cols-3">
          ...
          <div className="flex">
            <select
              id="passengers"
              class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  max-w-[10rem] mr-2"
            >
            ...
            <div class="relative flex items-center max-w-[10rem]">
              ...
              <input
                ...
                class="bg-gray-50 border-x-0 border-gray-300 h-11 font-medium text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full pb-3 "
                placeholder=""
